/* For fetching records we need a database table; for that we create a "reg" table in our database.
 ...
 1. insert into emp values ('Sankarshan', 'sankarshan@me.com', 'welcome', 'India','West Bengal','8100878312');
 
 2. insert into emp values ('Spandan', 'spandie990@gmail.com' , '1234', 'India','West Bengal','9831494819');*/
...
public class Login extends JFrame implements ActionListener
{
    ...
    public void showData()
    {
        ...
        try
        {
            ...
            Connection con = DriverManager.getConnection("jdbc:oracle:thin:@mcndesktop07:1521:xe", "username", "password");
